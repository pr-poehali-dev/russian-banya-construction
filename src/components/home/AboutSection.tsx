...
const AboutSection = ({ scrollToSection }: AboutSectionProps) => {
  ...
  const galleryImages = [
    ...
    "https://cdn.poehali.dev/projects/d33cb4c1-0952-4afa-b115-887b4c7da346/bucket/95221fa3-0900-4b4b-9018-f9fc4727ecce.png",
    "https://cdn.poehali.dev/projects/d33cb4c1-0952-4afa-b115-887b4c7da346/bucket/bb171ed1-be82-49b5-b03a-0bb51536c0c9.jpg",
    "https://cdn.poehali.dev/projects/d33cb4c1-0952-4afa-b115-887b4c7da346/bucket/d32c5f9f-865c-4357-bb41-34c5ae4ef2b5.jpg",
            ...
            <div className="text-base md:text-base text-muted-foreground leading-relaxed space-y-4 break-words">
              ...
              <div className="mt-6 p-4 bg-orange-50 border-2 border-orange-500 rounded-lg">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <p className="text-base sm:text-lg font-bold text-black">Провожу семинары для заказчиков "Строительство правильной русской бани" </p>
                </div>
