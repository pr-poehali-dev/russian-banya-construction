...
const Footer = () => {
  return (
    <footer id="contacts" className="bg-yellow-500 text-black py-8 px-4 sm:px-6 w-full overflow-x-hidden">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold mb-3 text-black">Пермский Пар</h3>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-black text-sm">
              <a href="tel:+73422984030" className="flex items-center justify-center md:justify-start gap-2 hover:text-gray-700 transition-colors">
                <Icon name="Phone" size={16} />
                +7 (342) 298-40-30
              </a>
              <a href="tel:+79824900900" className="flex items-center justify-center md:justify-start gap-2 hover:text-gray-700 transition-colors">
                <Icon name="Phone" size={16} />
                +7 (982) 490-09-00
              </a>
              <a href="mailto:perm-par@mail.ru" className="flex items-center justify-center md:justify-start gap-2 hover:text-gray-700 transition-colors sm:col-span-2">
        ...
        <div className="border-t border-black/20 mt-6 pt-6 text-center text-black text-sm">
